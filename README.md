...
FastCode is an optimized fork of [OpenCode](https://github.com/anomalyco/opencode) — a terminal-based AI coding tool that's been rewritten for speed. It works with cloud models (Claude, GPT, Gemini) or runs fully offline with Qwen 3 Coder 30B via Ollama.

🌐 **Website**: [fastcode-dev.com](https://fastcode-dev.com)
...
3. Run FastCode — it detects Ollama automatically
...
👉 [Get FastCode](https://fastcode-dev.com)
...
- **Issues**: [GitHub Issues](https://github.com/Fuzu/fastcode-dev.com/issues)

## Built on

FastCode is a fork of [OpenCode](https://github.com/anomalyco/opencode), licensed under MIT. Our optimizations, OIDX engine, and proprietary features are what you're paying for. The original OpenCode remains free and open source.

## License

Proprietary. See [Terms of Service](https://fastcode-dev.com/terms.html).
